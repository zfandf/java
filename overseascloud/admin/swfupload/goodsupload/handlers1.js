...
//alert(serverData);
	...
	//alert(dataobj.data.big_img);
	if(dataobj.msg=="")
	{
		
		//gallery_list=document.getElementById("gallery_list").html
		//alert(dataobj.data.big_img);
		document.getElementById("goods_img_box").src = dataobj.data.big_img;
		
		//document.getElementById("gallery_list").innerHTML=gallery_list+"<div><input type='hidden' value='"+dataobj.data.id+"' name='goods_gallerys[]' /><img src='"+dataobj.data.small_img+"' onclick='setgallery("+dataobj.data.id+")' /><br /><a href='javascript:;' onclick='delgallery("+dataobj.data.id+",this)'>删除</a></div>";
		//$("#gallery_list").append();
