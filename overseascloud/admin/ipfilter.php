...
InitGP(array("page","action","value","ipid","ids","did","delids","name")); //初始化变量全局返回
...
if(empty($action)){
	...
	$wherestr[]="ip <> ''";
	if(!empty($keywords))$wherestr[]=" CONCAT(ipid,' ',uname,' ',addtime) like '%$keywords%' ";
