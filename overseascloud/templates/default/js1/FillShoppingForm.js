...
function toShoppingCart() {
	...
	prodata.gsItemRemark = $("#gsItemRemark").val(); //过滤换行符或者空格
	prodata.gsItemRemark=prodata.gsItemRemark.replace(/[\r\n]/, ''); 	
