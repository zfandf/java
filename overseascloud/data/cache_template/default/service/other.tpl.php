...
<form name="service_product_list" method="post" action="<?php echo url("service.php?action=add&type=$action"); ?>" style="padding:0px; margin:0px;">
                      <table cellspacing="0" cellpadding="0" border="0" class="form-table">
                        <tbody>
                          ...
                          <tr>
                            <th class="tel-num" scope="row"><label>网站名称：</label></th>
                            <td><span class="tel-input-label">
                              <input type="text" name="webname" autocomplete="off" maxlength="50" class="tel-input" id="J_TelInput" style="color: rgb(128, 128, 128);" />
                            </span></td>
                          </tr>
                          <tr>
                            <th class="tel-num" scope="row"><label><?php echo URL;?>：</label></th>
                            <td><span class="tel-input-label">
                              <input type="text" name="weburl" autocomplete="off" maxlength="50" class="tel-input" id="J_TelInput" style="color: rgb(128, 128, 128);" />
                            </span></td>
                          </tr>
                          <tr>
                            <th class="tel-num" scope="row"><label>充值帐号：</label></th>
                            <td><span class="tel-input-label">
                          ...
                          <tr>
                            <th class="tel-num" scope="row"><label>备注：</label></th>
                            <td><span class="tel-input-label">
                              <input type="text" name="remark" autocomplete="off" maxlength="50" class="tel-input" id="J_TelInput" style="color: rgb(128, 128, 128);" />
                            </span></td>
                          </tr>
                          <tr>
                            <td colspan="2"><button id="J_SubmitButton" class="btn-submit" type="submit">点此充值 </button>
                             <a href="" target="_blank">大概几小时后到帐</a> </td>
                          </tr>
                        </tbody>
                      </table>
</form>
